...
//    @IBOutlet weak var resendButton: UIButton!
    ...
    var mobileNumberText: String? // get object to MobileLogin Screen
...
//        verifyButton.alpha = 0.5
    ...
    @objc func updateCountdown() {
        ...
        if countdownValue == 0 {
            ...
            resendLabel.isEnabled = true // Enable the button again
...
//
                self.showTopSideAlert(ofType: "Warning", title: "Warning", withMessage: "Please enter a valid OTP.")
            }
        }
...
//                self.present(alert, animated: true)
                self.showTopSideAlert(ofType: "Warning", title: "Warning", withMessage: "\(error.localizedDescription)")
            }
        }
    }
}
...
//                self.showTopSideAlert(ofType: "Success", title: "Successful", withMessage: "WELCOME \(self.userDetailsModelResult?.customerFirstName ?? "") \(self.userDetailsModelResult?.customerLastName ?? "")")
                DispatchQueue.main.async {
                    self.showTopSideAlert(ofType: "Success", title: "Successful", withMessage: "WELCOME \(self.userDetailsModelResult?.customerFirstName ?? "") \(self.userDetailsModelResult?.customerLastName ?? "")")
